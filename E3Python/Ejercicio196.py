class Agenda:
    ...
    def cargar(self):
        ...
        telefono=raw_input("Ingrese el numero de telefono:")
        mail=raw_input("Ingrese el mail:")
    ...
    def consulta(self):
        print("______________________________________________")        
        nombre=raw_input("Ingrese el nombre de la persona a consultar:")
    ...
    def modificacion(self):
        print("______________________________________________")        
        nombre=raw_input("Ingrese el nombre de la persona a modificar el telefono y mail:")
        if nombre in self.contactos:
            telefono=raw_input("Ingrese el nuevo telefono:")
            mail=raw_input("Ingrese el nuevo mail:")
            self.contactos[nombre]=(telefono,mail)
        else:
